...
def main(folder: Path):
    ...
    for file in parser.DOC_FORMAT:
        handle_media(file, folder / 'documents' / 'DOC')
    for file in parser.DOCS_FORMAT:
        handle_media(file, folder / 'documents' / 'DOCS')
    for file in parser.TXT_FORMAT:
        handle_media(file, folder / 'documents' / 'TXT')
    for file in parser.XLSX_FORMAT:
        handle_media(file, folder / 'documents' / 'XLSX')
    for file in parser.PPTX_FORMAT:
        handle_media(file, folder / 'documents' / 'PPTX')
    for file in parser.PDF_FORMAT:
